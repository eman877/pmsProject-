    ...
    <div class="container px-4 px-lg-5 mt-5">
        <div class="row">
            <div class="col-8 mx-auto">
                <form method="POST" action="handlers/users/regist_user.php" class="form border my-2 p-3">
                    <div class="mb-3">
                        <div class="mb-3">
                <label>Name:</label><br>
               ...
               <input type="password" name="confirm_password"class="form-control" ><br><br>
                        ...
                        <div class="mb-3">
                            <input type="submit"name="register" value="Register" id="" class="btn btn-success">
                        </div>
                    </div>
                </form>
            </div>
